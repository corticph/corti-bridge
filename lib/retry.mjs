...
// 401/403 (bad CORTI_BEARER) and 429 ("slow down", not a transient fault) are absent: retrying
// them multiplies cost/load. The client backs off on its own; Retry-After is preserved.
